        ...
        switch (type) {
            ...
            case FIELD:
                return "Fields in UML represent attributes of a class. Each field has a name and a type, " +
                        ...
                        "\n Rename: This function is in development";
            case PARAMETER:
                return "Parameters in UML represent inputs to methods. Each parameter has a name and a type, " +
                        ...
                        "\n Rename: This function is in development";
            case CLASS:
                return "Classes in UML represent blueprints for objects. Classes can have fields, methods, and relationships. "
            ...
            case GENERAL:
                return "UML (Unified Modeling Language) is a standardized visual language used to describe and model software systems. "
